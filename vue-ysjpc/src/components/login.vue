    ...
    <div class="login-edit-wrapper">
      ...
      <div class="edit-inner">
        ...
        <div class="list-item">
          ...
          <div class="ipt">
            <input type="password" v-model="dataOption.password" @input="filter('password')"  @keyup="_login(1)" />
          </div>
        </div>
        <!-- <div class="list-item">
        ...
        <div class="login-btn" @click="_login(0)">登录</div>
        <!-- 提示框 -->
  ...
  export default {
    ...
    methods: {
      _login (type, event) {
        ...
        if (!(e && e.keyCode === 13) && type === 1) { // enter键
          return;
        }
