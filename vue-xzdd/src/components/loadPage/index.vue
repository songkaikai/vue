...
<style lang="stylus" rel="stylesheet/stylus" scoped>
  ...
  .load-page .qmgs-icon{position:absolute;top:50%;left:50%;width: 150px;height:150px;-webkit-transform:translate(-75px, -170px);background: url(./xzdd_icon.png) no-repeat;background-size: 100% 100%;margin:auto;}
  .load-page .qmgs-icon .icon-btn{display: block;width:118px;height:39px;position: absolute;bottom:-140px; left:50%;margin-left:-59px;}
