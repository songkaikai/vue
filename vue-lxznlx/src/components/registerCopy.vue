...
<!--       <p class="title">欢迎使用</p>
      ...
      <div class="inner-wrapper">
        ...
        <div class="next-page" v-show="!prevPage">
          <div class="list-item border-bottom-1px" style="margin: 3rem 0 2rem 0;" @click="_showDialog">
            <span class="none-msg" v-if="dataOption.areaId === ''">请输入省、市、区</span>
            <span class="has-msg" v-else>{{ dataOption.areaName }}</span>
          </div>
          <div class="register-btn" @click="_register">注册</div>
          <div class="register-btn" @click="_prev" style="background: rgba(74, 161, 254, 0.3)">上一步</div>
        </div>
