...
// 工分的接口
// var baseUrl = process.env.NODE_ENV !== 'production' ? 'http://staff.sj.my.com/v2/' : 'https://staffapi.megglife.com/v1/';
// var baseUrl = process.env.NODE_ENV !== 'production' ? 'http://staffv2.megglife.com/v2/' : 'https://newstaffapi.megglife.com/v2/';
var baseUrl = process.env.NODE_ENV !== 'production' ? 'https://newstaffapi.megglife.com/v2/' : 'https://newstaffapi.megglife.com/v2/';
