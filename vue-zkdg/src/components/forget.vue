  ...
  <div class="register-page">
    <div class="register-wrapper">
      ...
      <div class="inner-wrapper">
        ...
        <div class="register-btn" @click="_register">确定</div>
      </div>
    </div>
    <!-- 提示框 -->
    ...
    methods: {
        ...
        _getValidateCode () {
          ...
          if (this.canGetCode === 1) {
            ...
            this.$store.dispatch('getValidateCode', {type: 3, mobile: String(this.dataOption.mobile)}).then(res => {
        ...
        _register () {
          ...
          this.$refs.loading.showLoad();
          this.$store.dispatch('forgetPass', this.dataOption).then(res => {
            this.$refs.loading.hideLoad();
            if (res.code === 1) {
              this._showTip('找回密码成功');
              this.dataOption = {
                mobile: '', // 手机号
                password: '', // 密码
                password_confirmation: '', // 确认密码
